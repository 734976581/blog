  ...
  <div class="category_edit">
    ...
    <el-form :model="form" :rules="rules" style="width:80%;">
      ...
      <el-form-item style="margin-bottom:5rem;">
        ...
        <el-button>
          <router-link to="/admin/content">取消</router-link>
        </el-button>
      </el-form-item>
    </el-form>
...
<script type="es6">
  ...
  export default {
    ...
    created() {
      this.$http.get('http://www.734976581.xyz:8081/admin/content/edit?id=' + this.$route.query['id']).then(response => {
    ...
    methods: {
      onSubmit() {
        ...
        this.$http.post('http://www.734976581.xyz:8081/admin/content/edit', {
